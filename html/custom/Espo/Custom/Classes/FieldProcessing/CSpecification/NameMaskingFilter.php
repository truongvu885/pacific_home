...
namespace Espo\Custom\Classes\FieldProcessing\CSpecification;
...
/**
 * Output filter để mask phần sau dấu "-" trong field name của CSpecification
...
class NameMaskingFilter implements Filter
{
    ...
    {
        // Chỉ xử lý cho entity CSpecification
        if ($entity->getEntityType() !== 'CSpecification') {
            return;
        }
