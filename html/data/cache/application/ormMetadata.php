  ...
  'CProduct' => [
    'attributes' => [
      ...
      'phoneNumber' => [
        ...
        'selectForeign' => [
          'select' => 'phoneNumberCProduct{alias}Foreign.name',
          'leftJoins' => [
            0 => [
              0 => 'EntityPhoneNumber',
              1 => 'phoneNumberCProduct{alias}ForeignMiddle',
              2 => [
                'phoneNumberCProduct{alias}ForeignMiddle.entityId:' => '{alias}.id',
                'phoneNumberCProduct{alias}ForeignMiddle.primary' => true,
                'phoneNumberCProduct{alias}ForeignMiddle.deleted' => false
              ]
            ],
            1 => [
              0 => 'PhoneNumber',
              1 => 'phoneNumberCProduct{alias}Foreign',
              2 => [
                'phoneNumberCProduct{alias}Foreign.id:' => 'phoneNumberCProduct{alias}ForeignMiddle.phoneNumberId',
                'phoneNumberCProduct{alias}Foreign.deleted' => false
              ]
            ]
          ]
        ],
      ...
      'phoneNumberIsOptedOut' => [
        ...
        'selectForeign' => [
          'select' => 'phoneNumberCProduct{alias}Foreign.optOut',
          'leftJoins' => [
            0 => [
              0 => 'EntityPhoneNumber',
              1 => 'phoneNumberCProduct{alias}ForeignMiddle',
      ...
      'phoneNumberIsInvalid' => [
        ...
        'selectForeign' => [
          'select' => 'phoneNumberCProduct{alias}Foreign.invalid',
          'leftJoins' => [
            0 => [
              0 => 'EntityPhoneNumber',
              1 => 'phoneNumberCProduct{alias}ForeignMiddle',
      ...
      'priceConverted' => [
        ...
        'selectForeign' => [
          'select' => 'MUL:({alias}.price, priceCurrencyRateCProduct{alias}Foreign.rate)',
          'leftJoins' => [
            0 => [
              0 => 'Currency',
              1 => 'priceCurrencyRateCProduct{alias}Foreign',
              2 => [
                'priceCurrencyRateCProduct{alias}Foreign.id:' => '{alias}.priceCurrency'
              ]
            ]
          ]
        ],
